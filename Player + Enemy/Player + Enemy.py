...
class enemyscreen():
	...
	def generate(self):
		...
		enemy.velocity = random.randint(1, 5)
...
player = player(630, 340, 128, 136) # Instatiates an object for the player class called player -
...
display.set_caption('Player + Enemy')
endProgram = False
